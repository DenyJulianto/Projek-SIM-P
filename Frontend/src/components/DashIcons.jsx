// Kumpulan ikon garis sederhana untuk dashboard; dipakai lewat <Ikon nama="grid" className="h-5 w-5" />.
const PATH = {
  ...
  monitor: ['M2 4h20v13H2z', 'M8 21h8', 'M12 17v4', 'M6 12l3-3 3 2 4-5'],
  ...
  award: ['M12 15a6 6 0 1 0 0-12 6 6 0 0 0 0 12z', 'M8.2 13.9L7 23l5-3 5 3-1.2-9.1'],
  ...
  school: ['M2 10l10-6 10 6', 'M4 10v10h16V10', 'M9 20v-6h6v6'],
