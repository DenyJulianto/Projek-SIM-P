...
@php($k = $laporan['konteks'])
    ...
    <div class="sub">
        ...
        @foreach (['rombel' => 'Rombel', 'ekskul' => 'Ekskul'] as $key => $label)
    ...
    <div class="foot">Dibuat {{ $dibuat }} oleh SIM Pendidikan. Laporan dihitung dari data modul Ekstrakurikuler saat dibuat.</div>
</body>
</html>
